...
export class SharedServiceService implements OnInit {
  ...
  ai = [
    {
      assistant: 'None',
      instructions: 'Reply in concise manner'
    },
    {
      assistant: 'Jarvis',
      instructions: "Please act like Jarvis from the MCU when replying to the user's prompts, limit responses to less than 50 words"
    },
    {
      assistant: 'Edith',
